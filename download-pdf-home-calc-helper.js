...
export const checkDisabledBtn = (calculateBtnNew) => {
    ...
    calculateBtnNew.classList.remove('grey-bg-new')
...
// function toggleDscBtn() {
//     console.log('atul')
//     const dscList = document.querySelector("#dsc-container > ul");

//     // const dscChild = dscList.childNodes
//     // console.log(dscList.children,'len')
//     // if (dscChild.length > 1) {
//     //     console.log('working')
//     // }

//     console.log(dscList, 'sujeet')
// }
...
export const createAccordian = (data) => {
    ...
    console.log(skuadFeeDiscount, 'skuadFeeDiscount')
    ...
    filteredData.forEach(item => {
        ...
        accordianHeader.style.borderBottom = "2px solid #17324B1A"
        accordianHeader.style.paddingBottom = "16px"
...
// https://dl.dropboxusercontent.com/scl/fi/k3zsgnps51ycdeyc1umm9/home-calc-helper.js?rlkey=uxldrl5gbsuzb3t3s5hlyqy7a&dl=0
// https://dl.dropboxusercontent.com/s/ge32rddhycpgdx0//helper.js

// https://dl.dropboxusercontent.com/scl/fi/8gqe8exjrgyl4kkgtjwus/home-calc.css?rlkey=16q5xqnj87ps8kqunwc1nfpto&dl=0

// https://dl.dropboxusercontent.com/scl/fi/hpom5a2d8npvzejrhrt4w/home-calc.js?rlkey=2sctzsik6nf8j2695culpy1do&dl=0


// https://dl.dropboxusercontent.com/scl/fi/k3zsgnps51ycdeyc1umm9/home-calc-helper.js
