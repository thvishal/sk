...
const _handleSubmit = async (e) => {
    ...
    const countryCd = countryList ? countryList.find(
        (country) => country.label === countryInput.value || (country.label == "India" && !e)
    ) : "India"

    console.log(countryList, 'countryList')
    if (!countryCd) return;

    const currencyCd = currencyList ? currencyList.find(
    ...
    console.log(countryCd.value, grossSalaryInput.value, currencyCd.value, 'me')
    ...
    data
        ...
        .then((res) => {
            if (res.success) {
                ...
                downloadPDFElement.classList.add('show-pdf-btn')
