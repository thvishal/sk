...
// if (location.href.includes('skuad-web.webflow.io')) {
//     baseUrl = "https://global-knowledge-base.skuad.in/api/cost-calculator/cost"
// }
// else {

//     baseUrl = 'https://global-knowledge-base.skuad.io/api/cost-calculator/cost'
// }
    ...
    data
        ...
        .then((res) => {
            if (res.success) {
                ...
                calcSectionRight.classList.add('adjust-grid-country-calc')
